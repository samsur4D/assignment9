...
const Details = () => {
    ...
    return (
        <div>
            <h2 className="text-4xl">{venue.length}</h2>
            {
                venue.map((vn)=>(
                    <div key={vn.id} className="p-5 mx-auto sm:p-10 md:p-16 dark:bg-gray-100 dark:text-gray-800">
                    <div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
                        ...
                        <div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md dark:bg-gray-50">
                            <div className="space-y-2">
                                <a rel="noopener noreferrer" href="#" className="inline-block text-2xl font-semibold sm:text-3xl mt-28">The Best Activewear from the Nordstrom Anniversary Sale</a>
