...
const Contactus = () => {
  ...
  const zoom = 13;
    return (
        ...
        <div className=''>
            <div>
            <Marquee speed={400} pauseOnHover className='text-5xl font-bold'>
	...
	<div className="flex flex-col justify-between">
		...
		<img className='rounded-3xl' src="https://www.premier.org.uk/wp-content/uploads/2021/01/Contact-us-1-1920x1080.jpg" />
	</div>
	<form noValidate="" className="space-y-6">
		<div>
			<label htmlFor="name" className="text-lg font-bold">Full name</label>
			<input id="name" type="text" placeholder="" className="w-full border border-black p-3 rounded dark:bg-gray-100" />
		</div>
		<div>
			<label htmlFor="email" className="text-lg font-bold">Email</label>
			<input id="email" type="email" className="w-full border border-black p-3 rounded dark:bg-gray-100" />
		</div>
		<div>
			<label htmlFor="message" className="text-lg font-bold">Message</label>
			<textarea id="message" rows="3" className="w-full border border-black p-3 rounded dark:bg-gray-100"></textarea>
		</div>
...
<img  className='w-[200px] h-[150px]' src="https://images.unsplash.com/photo-1596178060727-1f6885ee334d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />

<img  className='w-[200px] h-[150px]' src="https://images.unsplash.com/photo-1596436887689-da7f170bd20c?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />

<img  className='w-[200px] h-[150px]' src="https://images.unsplash.com/photo-1596436889106-be35e843f974?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />

<img  className='w-[200px] h-[150px]' src="https://images.unsplash.com/photo-1596178060810-72f53ce9a65c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
