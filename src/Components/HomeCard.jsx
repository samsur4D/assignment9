        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-5'>
                {
                    venue.map((vn)=> ( 
                        ...
                        <div className="flex flex-col justify-between p-6 space-y-8">
                            ...
                            {/* ---------- */}
                            <button to="/details" href="#_" className="relative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group">
